                    ...
                    <div id="config-components">
                        ...
                        <div id="core-component-group1">
                            ...
                            <fieldset class="component-group-list">
                                ...
                                <div class="field-pair row">
                                    <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
                                        <span class="component-title">${_('Auto download new episodes')}</span>
                                    </div>
                                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <input type="number" class="form-control input-sm" min="0" id="stay_ahead" name="stay_ahead" value="${show.stay_ahead}" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="stay_ahead">${_('This will download new episodes automatically.')}</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
