...
var SICKRAGE = {
                ...
                $('.show-grid').show().isotope({
                    ...
                    getSortData: {
                        ...
                        added: function(itemElem) {
                            const date = $(itemElem).attr('data-added');
                            return -(date.length && parseInt(date, 10) || Number.POSITIVE_INFINITY);
                        },
                        lastseen: function(itemElem) {
                            const date = $(itemElem).attr('data-lastseen'), ret = Number.POSITIVE_INFINITY;
    ...
    addShows: {
        init: function() {
            ...
            $('#statusSelect, #qualityPreset, #season_folders, #stay_ahead, #anyQualities, #bestQualities, #subtitles, #scene, #anime, #statusSelectAfter').on('change', function () {
